...
public class FastjsonTest {
    public static void main(String[] args) {
        ...
        // Map<String, Map<String, Long>> list = new HashMap<String, Map<String, Long>>();
        // Map<String, Long> stringLongHashMap = new HashMap<String, Long>();
        // list.put("1", stringLongHashMap);
        // stringLongHashMap.put("1", 1L);
        // stringLongHashMap.put("2", 2L);
        // stringLongHashMap.put("1", 3L);
